...
{
    public class clsSunnyUIDataGridViewSettings
    {
        static List<string> _ListNumericalColumns = new List<string>();

        public static void LoadData(DataTable dt, UIDataGridView dgv, UIComboBox cb, List<string> ListNumericalColumns = null, int width = 100)
        {
        ...
        public static void HandleTextBoxChangingEvent(UITextBox tx, UIComboBox cb, DataTable dtList)
        {
            if (cb.Items.Count==0)
            {
                return;
